...
import co.edu.control.BoardListPagingContorl;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		mappings.put("/memberLoginOut.do", new memberLoginOutControl()); // 로그아웃
		
		mappings.put("/addBoard.do", new AddBoardControl()); // 게시글 등록화면
		mappings.put("/insertBoard.do", new InsertBoardControl()); // 게시글 등록
		mappings.put("/boardList.do", new BoardListControl()); // 게시글 목록
		mappings.put("/boardListPaging.do", new BoardListPagingContorl());
